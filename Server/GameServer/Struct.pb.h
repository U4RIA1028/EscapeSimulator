...
class ObjectFindRazor;
struct ObjectFindRazorDefaultTypeInternal;
extern ObjectFindRazorDefaultTypeInternal _ObjectFindRazor_default_instance_;
class ObjectInfo;
...
template<> ::Protocol::ObjectFindRazor* Arena::CreateMaybeMessage<::Protocol::ObjectFindRazor>(Arena*);
...
class ObjectFindRazor final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.ObjectFindRazor) */ {
 public:
  inline ObjectFindRazor() : ObjectFindRazor(nullptr) {}
  ~ObjectFindRazor() override;
  explicit PROTOBUF_CONSTEXPR ObjectFindRazor(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ObjectFindRazor(const ObjectFindRazor& from);
  ObjectFindRazor(ObjectFindRazor&& from) noexcept
    : ObjectFindRazor() {
    *this = ::std::move(from);
  }

  inline ObjectFindRazor& operator=(const ObjectFindRazor& from) {
    CopyFrom(from);
    return *this;
  }
  inline ObjectFindRazor& operator=(ObjectFindRazor&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ObjectFindRazor& default_instance() {
    return *internal_default_instance();
  }
  static inline const ObjectFindRazor* internal_default_instance() {
    return reinterpret_cast<const ObjectFindRazor*>(
               &_ObjectFindRazor_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(ObjectFindRazor& a, ObjectFindRazor& b) {
    a.Swap(&b);
  }
  inline void Swap(ObjectFindRazor* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ObjectFindRazor* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ObjectFindRazor* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ObjectFindRazor>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ObjectFindRazor& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ObjectFindRazor& from) {
    ObjectFindRazor::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ObjectFindRazor* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.ObjectFindRazor";
  }
  protected:
  explicit ObjectFindRazor(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.ObjectFindRazor)
 private:
  class _Internal;
...
// float start_x = 1;
inline void ObjectFindRazor::clear_start_x() {
  _impl_.start_x_ = 0;
}
inline float ObjectFindRazor::_internal_start_x() const {
  return _impl_.start_x_;
}
inline float ObjectFindRazor::start_x() const {
  // @@protoc_insertion_point(field_get:Protocol.ObjectFindRazor.start_x)
  return _internal_start_x();
}
inline void ObjectFindRazor::_internal_set_start_x(float value) {
  
  _impl_.start_x_ = value;
}
inline void ObjectFindRazor::set_start_x(float value) {
  _internal_set_start_x(value);
  // @@protoc_insertion_point(field_set:Protocol.ObjectFindRazor.start_x)
}

// float start_y = 2;
inline void ObjectFindRazor::clear_start_y() {
  _impl_.start_y_ = 0;
}
inline float ObjectFindRazor::_internal_start_y() const {
  return _impl_.start_y_;
}
inline float ObjectFindRazor::start_y() const {
  // @@protoc_insertion_point(field_get:Protocol.ObjectFindRazor.start_y)
  return _internal_start_y();
}
inline void ObjectFindRazor::_internal_set_start_y(float value) {
  
  _impl_.start_y_ = value;
}
inline void ObjectFindRazor::set_start_y(float value) {
  _internal_set_start_y(value);
  // @@protoc_insertion_point(field_set:Protocol.ObjectFindRazor.start_y)
}

// float start_z = 3;
inline void ObjectFindRazor::clear_start_z() {
  _impl_.start_z_ = 0;
}
inline float ObjectFindRazor::_internal_start_z() const {
  return _impl_.start_z_;
}
inline float ObjectFindRazor::start_z() const {
  // @@protoc_insertion_point(field_get:Protocol.ObjectFindRazor.start_z)
  return _internal_start_z();
}
inline void ObjectFindRazor::_internal_set_start_z(float value) {
  
  _impl_.start_z_ = value;
}
inline void ObjectFindRazor::set_start_z(float value) {
  _internal_set_start_z(value);
  // @@protoc_insertion_point(field_set:Protocol.ObjectFindRazor.start_z)
}

// float end_x = 4;
inline void ObjectFindRazor::clear_end_x() {
  _impl_.end_x_ = 0;
}
inline float ObjectFindRazor::_internal_end_x() const {
  return _impl_.end_x_;
}
inline float ObjectFindRazor::end_x() const {
  // @@protoc_insertion_point(field_get:Protocol.ObjectFindRazor.end_x)
  return _internal_end_x();
}
inline void ObjectFindRazor::_internal_set_end_x(float value) {
  
  _impl_.end_x_ = value;
}
inline void ObjectFindRazor::set_end_x(float value) {
  _internal_set_end_x(value);
  // @@protoc_insertion_point(field_set:Protocol.ObjectFindRazor.end_x)
}

// float end_y = 5;
inline void ObjectFindRazor::clear_end_y() {
  _impl_.end_y_ = 0;
}
inline float ObjectFindRazor::_internal_end_y() const {
  return _impl_.end_y_;
}
inline float ObjectFindRazor::end_y() const {
  // @@protoc_insertion_point(field_get:Protocol.ObjectFindRazor.end_y)
  return _internal_end_y();
}
inline void ObjectFindRazor::_internal_set_end_y(float value) {
  
  _impl_.end_y_ = value;
}
inline void ObjectFindRazor::set_end_y(float value) {
  _internal_set_end_y(value);
  // @@protoc_insertion_point(field_set:Protocol.ObjectFindRazor.end_y)
}

// float end_z = 6;
inline void ObjectFindRazor::clear_end_z() {
  _impl_.end_z_ = 0;
}
inline float ObjectFindRazor::_internal_end_z() const {
  return _impl_.end_z_;
}
inline float ObjectFindRazor::end_z() const {
  // @@protoc_insertion_point(field_get:Protocol.ObjectFindRazor.end_z)
  return _internal_end_z();
}
inline void ObjectFindRazor::_internal_set_end_z(float value) {
  
  _impl_.end_z_ = value;
}
inline void ObjectFindRazor::set_end_z(float value) {
  _internal_set_end_z(value);
  // @@protoc_insertion_point(field_set:Protocol.ObjectFindRazor.end_z)
}
